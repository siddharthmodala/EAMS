...
<html>
<head>
<meta http-equiv="Proffessional Tax Calculation" content="text/html; charset=ISO-8859-1">
...
<br><br><br>
 <form name="f" method="post" action="updateptax.jsp" onsubmit="return validate();">
  <table border="0" align="center">
   <caption> <b>Professional tax Scale</b> </caption>
    <tr>
...
<% 
	...
	try{
		db=new Database();
		ResultSet rs=db.executeDBQuery("select * from ptaxscale order by sqno");
		int i=1;
		if(rs.next())
		{
		do
