...
try{
	...
	ResultSet rs=db.executeDBQuery("select t.empid,t.ename,t.lic from "+table+" t,designations d where month='"+month+"'  and t.designation=d.designation order by (d.pno)");	
	%>
	<table align="center" border="1" >
	<caption><b>L.I.C. Statement for the month of <%=month%>,<%=year%>-<%=year+1%><br><br></b></caption>
	<tr>
	<th >SL.No</th>
	<th width="250px">Name of the Employee</th>	
	<th width="250px">Premium Amount(Rs.)</th>
	</tr>
	<%
	while(rs.next())
	{		
